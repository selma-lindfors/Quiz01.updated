...
!(function(p) {
  ...
  (p.fetch = function(t) {
    ...
    (p.parse = function(e, r) {
      ...
      for (
        a = function(e) {
          return (
            !0 !== u &&
              ("" === e ? (e = null) : !0 === i.skipinitialspace && (e = g(e)),
              m.test(e)
                ? (e = parseInt(e, 10))
                : h.test(e) && (e = parseFloat(e, 10))),
            e
          );
        },
          o = 0;
    ...
    (p.objectToArray = function(e) {
      for (var r = [], t = [], n = 0; n < e.fields.length; n++)
        t.push(e.fields[n].id);
      r.push(t);
      for (n = 0; n < e.records.length; n++) {
        for (var i = [], o = e.records[n], a = 0; a < t.length; a++)
          i.push(o[t[a]]);
        r.push(i);
      }
      return r;
